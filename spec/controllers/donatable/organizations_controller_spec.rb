...
module Donatable
  RSpec.describe OrganizationsController, type: :controller do
    ...
    let(:valid_session) { current_id = {id: 1} }

    describe 'GET #index' do
      it 'returns a success response' do
        FactoryGirl.create(:donatable_organization)
    ...
    describe 'GET #show' do
      it 'returns a success response' do
        organization = FactoryGirl.create(:donatable_organization)
  ...
  #         post :create,
  #              params: {
  #                organization: invalid_attributes
  #              },
  #              session: valid_session
  #         expect(response).to be_success
  #       end
